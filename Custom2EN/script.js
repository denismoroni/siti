document.addEventListener('DOMContentLoaded', () => {
    ...
    // Elementi e modale per i titoli globali   Questa versione stampa HTML con ridimensionamento corretto
    ...
    let configData = {
        globalTitle: "Custom website",
        globalHeading: "Custom website",
        globalTableHeading: "How To Use It",
        bodyBgColor: "#A3A3A3",
        ...
        steps: [
            {
                ...
                description: "will help you customize the page as you wish",
                image: "1.jpg",
                link: "",
                linkConfirm: true
            },
            {
                title: "The 'Words' section",
                description: "will allow you to decide on the words contained in your text",
                image: "2.jpg",
                link: "",
                linkConfirm: true
            },
            {
                title: "The 'Colors' section",
                description: "will let you decide on the colors of the text and backgrounds",
                image: "3.jpg",
                link: "",
                linkConfirm: true
            },
            {
                title: "The 'Metrics' section",
                description: "adjusts font, size, alignment, and text style",
                image: "4.jpg",
                link: "",
                linkConfirm: true
            },
            {
                title: " You can edit each section ",
                description: "for text, images, and links",
                image: "5b.jpg",
                link: "",
                linkConfirm: true
            },
            {
                ...
                description: "save your configuration, reload it, or start from scratch",
                image: "5.jpg",
                link: "",
                linkConfirm: true
            },
            {
                title: " from your exported file ",
                description: "I can create a new page (you will need to send me your images)",
                image: "9.png",
            ...
            },
            {
                ...
                description: "by clicking here - text messages only please.",
                image: "6.png",
    ...
    <div class="edit-buttons">
        <button class="edit-btn bg-blue-500 text-white rounded px-2 py-1" data-index="${index}">Edit</button>
        <button class="delete-btn bg-red-500 text-white rounded px-2 py-1" data-index="${index}">Delete</button>
    ...
    const attachEventListeners = () => {
     ...
     row.onclick = (e) => {
      ...
      if (link) {
        if (step.linkConfirm !== false) {
          if (confirm('Vuoi aprire questo link?')) {
        ...
        document.querySelectorAll('.edit-btn').forEach(button => {
            button.onclick = (e) => {
				...
				document.getElementById('modalLinkConfirm').checked = (step.linkConfirm !== false);
    ...
    exportHtmlBtn.addEventListener('click', () => {
        const stepsHtml = configData.steps.map(step => {
            let imageHtml = step.image ? `<img src="IMG/${step.image}" alt="${step.title}">` : '';
            ...
            return `
                <tr ${linkHtml}>
                    <td>
                        <div class="image-title" style="font-family: ${configData.headingFontFamily}; font-size: ${configData.sectionTitleSize}px; color: ${configData.sectionTitleColor}; font-weight: ${configData.headingBold ? 'bold' : 'normal'}; font-style: ${configData.headingItalic ? 'italic' : 'normal'}; text-align: ${configData.titleAlignment};">${step.title}</div>
                        <div class="step-description" style="font-family: ${configData.descriptionFontFamily}; font-size: ${configData.descriptionSize}px; color: ${configData.descriptionColor}; font-weight: ${configData.descriptionBold ? 'bold' : 'normal'}; font-style: ${configData.descriptionItalic ? 'italic' : 'normal'}; text-align: ${configData.descriptionAlignment};">${step.description}</div>
                        ${imageHtml}
                    </td>
                </tr>
            `;
...
<head>
    ...
    <style>
        body {
            background-color: ${configData.bodyBgColor};
            margin: 0;
            padding: 1.5rem;
        ...
        .container {
            ...
            background-color: ${configData.containerBgColor};
            box-sizing: border-box;
        }
        h1 {
            text-align: center;
        ...
        #installationTable {
            ...
            background-color: ${configData.tableBgColor};
            box-sizing: border-box;
            table-layout: auto;
            word-break: break-word;
        }
        #installationTable th, #installationTable td {
            border: none;
            padding: 1rem;
            vertical-align: top;
            word-break: break-word;
        ...
        /* Responsive: ridimensiona contenitore, testo e padding su schermi piccoli */
...
`;
    ...
    saveModalBtn.addEventListener('click', () => {
        if (currentStepIndex > -1) {
			...
			configData.steps[currentStepIndex].linkConfirm = document.getElementById('modalLinkConfirm').checked;
            saveData();
            renderTable();
            renderColors();
            renderText();
